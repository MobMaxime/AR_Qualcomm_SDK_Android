...
import com.mobmaxime.common.CubeShaders;
import com.mobmaxime.common.SampleUtils;
import com.mobmaxime.common.Teapot;
...
public class CloudRecoRenderer implements GLSurfaceView.Renderer
{
    ...
    private RecogActivity mActivity;
    
    public CloudRecoRenderer(SampleApplicationSession session, RecogActivity activity)
    {
